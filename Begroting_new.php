   ...
   <div class="side-nav">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Nieuw Budget</h6>
          </div>
          <div class="card-body">
          <form action="Begroting_save.php" method="POST" enctype="multipart/form-data">
                 ...
                 <input required list="Bedrijf" type="text" class="form-control" name="Bedrijf" placeholder="Bedrijfsnaam">
					 <datalist id="Bedrijf">
					 <?php
