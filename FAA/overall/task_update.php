                ...
                <div class="task_info">
                    ...
                    <div class="task_name">
                        <div class="col-12">
                            ...
                            <input type="text" name="task" class="form-control text-dark text-uppercase font-weight-bolder text-center" placeholder="<?php echo $taak ;?>">
                        </div>
                        <div class=" col-12 mt-3">
                            <h3 class="text-sm text-secondary font-weight-normal">Responsible</h3>
                            <input   list="lead" name="project_lead" type="text" class="form-control text-dark text-center text-uppercase font-weight-bolder" placeholder="<?php echo $persoon ;?>">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <textarea  class="form-control text-dark font-weight-bolder text-center" cols="20" rows="3"><?php echo $bes ;?></textarea>
                        </div>
